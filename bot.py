...
aliexpress = AliexpressApi('514130', 'nV8vFBa61NIsLcx2kOgJjoRByzmIfnO0',
...
btn4 = types.InlineKeyboardButton("🎬 شاهد كيفية عمل البوت 🎬",
                                  url="https://t.me/s/Red_Store0")
btn5 = types.InlineKeyboardButton(
    "💰  حمل تطبيق Aliexpress عبر الضغط هنا للحصول على مكافأة 5 دولار  💰",
    url="https://a.aliexpress.com/_mtV0j3q")
btn3 = types.InlineKeyboardButton("❤️ اشترك في القناة للمزيد من العروض ❤️", url="https://t.me/s/Red_Store0")
...
def get_affiliate_links(message, message_id, link):
  affiliate_link = 'رابط العملات غير معرف'
  super_links = 'رابط السوبر غير معرف'
  try:
